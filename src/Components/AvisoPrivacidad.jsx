...
const AvisoPrivacidad = () => {
  return (
    /* Agregamos un contenedor con fondo blanco para contraste absoluto */
    <div className="privacidad-pagina" style={{ 
      padding: '120px 20px', 
      maxWidth: '100%', 
      margin: '0 auto', 
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div className="cuerpo-aviso" style={{ lineHeight: '1.8', color: '#1a1a1a', textAlign: 'justify' }}>
          ...
          <p>Sus datos tienen como fin principal la prospección comercial, el cálculo preciso de suministros y la logística de entrega de material. No vendemos ni cedemos sus datos a terceros ajenos a la operación de Bricko.</p>
